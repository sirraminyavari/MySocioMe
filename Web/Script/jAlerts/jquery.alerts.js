                    ...
                    { Type: "div", Style: "float:left; margin-top:4px;",
                        Childs: [
                            { Type: "img", Style: "width:16px; height:16px; cursor:pointer;",
                                Attributes: [{ Name: "src", Value: "../../ReDesign/images/Delete.png"}],
                                Properties: [
                                    { Name: "onmouseover", Value: function () { this.setAttribute("src", "../../ReDesign/images/Delete-over.png"); } },
                                    { Name: "onmouseout", Value: function () { this.setAttribute("src", "../../ReDesign/images/Delete.png"); } },
